...
vim.api.nvim_create_autocmd('LspAttach', {
  ...
  callback = function(ev)
    ...
    keymap.set('n', '<space>ws', vim.lsp.buf.workspace_symbol, desc('lsp [w]orkspace symbol [q]'))
    keymap.set('n', '<space>ds', vim.lsp.buf.document_symbol, desc('lsp [dd]ocument symbol'))
    keymap.set('n', '<space>k', vim.lsp.buf.code_action, desc('[lsp] code action'))
    keymap.set('n', '<space>l', vim.lsp.codelens.run, desc('[lsp] run code lens'))
    keymap.set('n', '<space>rl', vim.lsp.codelens.refresh, desc('lsp [c]ode lenses [r]efresh'))
